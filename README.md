...
1. Criar arquivo novo → Salvar como **.docm** (Word) ou **.xlsm** (Excel)
2. Pressionar `Alt + F11` → Inserir → Módulo → Colar o código
3. Fechar e abrir o arquivo → **Habilitar apenas neste teste**
4. Observar: só executa porque **VOCÊ** autorizou — esse é o ponto de defesa!

---

## ⚙️ Configurações Recomendadas do Office
...
### 🛡️ Ativar Visualização Protegida
...
> Vírus de macro **não funcionam sozinhos**. Dependem de DUAS falhas combinadas:
> 1. ⚙️ Office configurado de forma permissiva
> 2. 👤 Usuário habilitando conteúdo sem desconfiar
>
